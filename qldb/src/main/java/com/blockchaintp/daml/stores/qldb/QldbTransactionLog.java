...
import static software.amazon.qldb.exceptions.QldbDriverException.create;
import io.vavr.API;
    ...
    try {
      ...
      return driver.execute(tx -> {
        ...
        if (res instanceof IonStruct) {
          ...
          var longValue = ((IonInt) seq).longValue();

          LOG.info("Commited transaction {} as seq {}", () -> txId, () -> longValue);
